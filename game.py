...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnStealthArcher,move_stealth_archers ,spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer,move_healers ,clearTroops
from buildings import shoot_cannons, shoot_wizard_towers, spec_exploded_tiles
...
while(True):
    ...
    # change add here u,t,y keys for st arch.
    elif ch == 'u':
    ...
    # print(spec_exploded_tiles)
    # print(spec_coords)
    for tile in spec_exploded_tiles:
        if tile[0] == spec_coords[0] and tile[1] == spec_coords[1]:
            King.deal_damage(200)
    spec_exploded_tiles.clear()
    move_healers(V, troops, King)
